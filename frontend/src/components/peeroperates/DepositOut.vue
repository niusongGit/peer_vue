...
import {Depositout} from "../../../wailsjs/go/peer/Api";
...
const submitForm = async (formEl: FormInstance | undefined) => {
    ...
    await formEl.validate((valid, fields) => {
        if (valid) {
            Depositout(store.getters.getPeerInfo.id,store.state.selectedAddress,parseFloat(ruleForm.amount.toString()),parseFloat(ruleForm.gas.toString()),ruleForm.pass).then((result) => {
