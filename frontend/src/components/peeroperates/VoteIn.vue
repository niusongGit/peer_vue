...
import {VoteIn} from "../../../wailsjs/go/peer/Api";
...
const submitForm = async (formEl: FormInstance | undefined) => {
    ...
    await formEl.validate((valid, fields) => {
        if (valid) {
            VoteIn(store.getters.getPeerInfo.id,parseInt(ruleForm.votetype.toString()),ruleForm.address,ruleForm.witness,parseFloat(ruleForm.amount.toString()),parseFloat(ruleForm.gas.toString()),parseFloat(ruleForm.rate.toString()),ruleForm.pass,'').then((result) => {
